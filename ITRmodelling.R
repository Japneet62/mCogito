## -------- ITEM RESPONSE THEORY - STEP 1.  DIMENSIONALITY ASSESSMENT -------- ## 
...
# --------------------------------------------------------------------------- # 
  ...
  # Attempt 2. Exploratory factor analysis 
  ...
  # Attempt 3. IFA 
    ...
    AMT1 <- mirt(a, 1, verbose = FALSE)
    AMT2 <- mirt(a, 2, verbose = FALSE, TOL = 0.001)
    anova(a, a, verbose = FALSE) 
